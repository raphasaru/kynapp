...
export default function PrivacidadePage() {
  return (
    <main className="min-h-screen bg-neutral-50 py-12 px-6">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl p-8 md:p-12 shadow-sm text-[#181d27]">
        {/* Back link */}
        <div className="mb-8">
        ...
        <h1 className="font-heading text-3xl md:text-4xl font-bold mb-4 text-[#181d27]">
        ...
        <h2 className="font-heading text-xl font-bold mt-10 mb-4 text-[#181d27]">1. Dados que coletamos</h2>

        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Dados de cadastro</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
          Coletamos email e nome para criar e gerenciar sua conta.
        </p>

        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Dados financeiros</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
        ...
        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Dados de uso</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
          Registramos páginas visitadas e funcionalidades utilizadas para melhorar a experiência do app.
        </p>

        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Dados do WhatsApp</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
        ...
        <h2 className="font-heading text-xl font-bold mt-10 mb-4 text-[#181d27]">2. Como usamos seus dados</h2>

        <ul className="list-disc pl-6 space-y-2 mb-4 text-[15px] text-neutral-700">
        ...
        <p className="text-[15px] leading-relaxed mb-4 font-semibold text-primary">
          NÃO vendemos, compartilhamos ou monetizamos dados pessoais com terceiros.
        </p>

        <h2 className="font-heading text-xl font-bold mt-10 mb-4 text-[#181d27]">3. Proteção dos dados</h2>

        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Criptografia AES-256-GCM</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
        ...
        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Row-Level Security</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
        ...
        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Autenticação segura</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
          Usamos autenticação moderna via Supabase, com tokens JWT e renovação automática de sessões.
        </p>

        <h2 className="font-heading text-xl font-bold mt-10 mb-4 text-[#181d27]">4. Seus direitos (LGPD)</h2>

        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
          De acordo com a Lei Geral de Proteção de Dados (LGPD), você tem os seguintes direitos:
        </p>

        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Direito de acesso</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
          Você pode solicitar informações sobre quais dados pessoais mantemos sobre você.
        </p>

        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Direito de correção</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
          Você pode atualizar dados incorretos ou desatualizados diretamente no app, na seção de configurações.
        </p>

        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Direito de exclusão</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
          Você pode deletar sua conta e todos os dados associados a qualquer momento. Acesse Configurações → Conta → Excluir conta.
        </p>

        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Direito de portabilidade</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
          Você pode exportar todos os seus dados financeiros em formato CSV ou PDF (disponível no plano Pro).
        </p>

        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Direito de revogar consentimento</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
        ...
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
          ...
          <strong className="text-[#181d27]">contato@kynapp.com.br</strong> (placeholder).
        </p>

        <h2 className="font-heading text-xl font-bold mt-10 mb-4 text-[#181d27]">5. Cookies e armazenamento local</h2>

        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Cookies de sessão</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
        ...
        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">localStorage</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
        ...
        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Sem rastreamento de terceiros</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
          Não usamos cookies de rastreamento, analytics de terceiros ou pixels de publicidade.
        </p>

        <h2 className="font-heading text-xl font-bold mt-10 mb-4 text-[#181d27]">6. Retenção de dados</h2>

        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Conta ativa</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
          Mantemos seus dados enquanto sua conta estiver ativa.
        </p>

        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Após exclusão da conta</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
        ...
        <h3 className="font-heading text-lg font-semibold mt-6 mb-2 text-[#181d27]">Plano Free</h3>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
        ...
        <h2 className="font-heading text-xl font-bold mt-10 mb-4 text-[#181d27]">7. Alterações nesta política</h2>
        ...
        <h2 className="font-heading text-xl font-bold mt-10 mb-4 text-[#181d27]">8. Contato</h2>

        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
          Se você tiver dúvidas sobre esta política ou sobre como tratamos seus dados, entre em contato:
        </p>
        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
          Email: <strong className="text-[#181d27]">contato@kynapp.com.br</strong> (placeholder)
        </p>

        <h2 className="font-heading text-xl font-bold mt-10 mb-4 text-[#181d27]">9. Data de vigência</h2>

        <p className="text-[15px] leading-relaxed mb-4 text-neutral-700">
          Esta política de privacidade está em vigor desde <strong className="text-[#181d27]">fevereiro de 2026</strong>.
        </p>
